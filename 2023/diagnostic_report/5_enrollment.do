...
// ------------------------------------------------------- //
	...
	// 1. Data clean
      ...
      keep if postula_comp_1 == 0 & postula_comp_2 == 0   // we want the ones that only participated in the main application period.

		// 1.6. Merging with enrollment

      preserve
          use `enrollment', clear
          rename (mrun rbd)(mrun_1 rbd_matriculado_post_1)
          tempfile enrollment_1
          save `enrollment_1', replace

          rename (mrun_1 rbd_matriculado_post_1)(mrun_2 rbd_matriculado_post_2)
      ...
      merge m:1 mrun_2 using `enrollment_2', keep(1 3) nogen
		...
		// 1.7. Creating relevant variables
      ...
      gen     matriculados_asig = 0
      replace matriculados_asig = 1 if rbd_matriculado_post_1 == rbd_final_1 & rbd_matriculado_post_2 == rbd_final_2
	...
	// 2. Analysis
		...
		// 2.0. Number of observations
			...
			tab group postula_en_bloque if both_assigned == 1 & respuesta_final_1 == 1 & respuesta_final_2 == 1

		// 2.1. Together: assigned to MA

			tabstat matriculados_asig if both_assigned == 1 & group == 2 & rbd_matriculado_1 == rbd_final_1 & rbd_matriculado_1 == rbd_final_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & ((rbd_matriculado_1 == rbd_final_1 & rbd_matriculado_1 == rbd_final_2) | (rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2)), stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2, stat(mean) by(postula_en_bloque)

			tabstat matriculados_asig if both_assigned == 1 & group == 2 & rbd_matriculado_1 == rbd_final_1 & rbd_matriculado_1 == rbd_final_2  & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2  & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & ((rbd_matriculado_1 == rbd_final_1 & rbd_matriculado_1 == rbd_final_2) | (rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2))  & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_matriculado_2 == rbd_final_1 & rbd_matriculado_2 == rbd_final_2  & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)

		// 2.2. Together: assigned to a new school

			tabstat matriculados_asig if both_assigned == 1 & group == 1 & rbd_final_1 == rbd_final_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 2 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_final_1 == rbd_final_2 & rbd_final_2 != rbd_matriculado_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1 & rbd_final_2 != rbd_matriculado_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1, stat(mean) by(postula_en_bloque)

			tabstat matriculados_asig if both_assigned == 1 & group == 1 & rbd_final_1 == rbd_final_2 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 2 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_final_1 == rbd_final_2 & rbd_final_2 != rbd_matriculado_2 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1 & rbd_final_2 != rbd_matriculado_2 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_final_1 == rbd_final_2 & rbd_final_1 != rbd_matriculado_1 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
		...
		// 2.3. Separated: assigned to MA
			...
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_final_1 != rbd_final_2 & rbd_final_2 == rbd_matriculado_2, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & rbd_final_1 != rbd_final_2 & (rbd_final_1 == rbd_matriculado_1 | rbd_final_2 == rbd_matriculado_2), stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_final_1 != rbd_final_2 & (rbd_final_1 == rbd_matriculado_1 | rbd_final_2 == rbd_matriculado_2), stat(mean) by(postula_en_bloque)


			tabstat matriculados_asig if both_assigned == 1 & group == 2 & rbd_final_1 != rbd_final_2 & rbd_final_1 == rbd_matriculado_1 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 3 & rbd_final_1 != rbd_final_2 & rbd_final_2 == rbd_matriculado_2 & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 4 & rbd_final_1 != rbd_final_2 & (rbd_final_1 == rbd_matriculado_1 | rbd_final_2 == rbd_matriculado_2) & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
			tabstat matriculados_asig if both_assigned == 1 & group == 5 & rbd_final_1 != rbd_final_2 & (rbd_final_1 == rbd_matriculado_1 | rbd_final_2 == rbd_matriculado_2) & respuesta_final_1 == 1 & respuesta_final_2 == 1, stat(mean) by(postula_en_bloque)
