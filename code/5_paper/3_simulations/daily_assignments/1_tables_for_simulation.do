...
// -----------------------------------------------------------------------------
	...
	// Objective: Need to create A, B, C and F tables (for daily applications)
	// Created: Jun 4, 2024
...
// ---------------------------------------------- //
	...
	// ---------------------------------------------- //
		...
		// ----------------------------------------------------------------
			...
			export delimited "$pathData/intermediate/feedback/2023/daily_simulations/1_tables_public_format/A1_`date'.csv", replace
		...
		// ----------------------------------------------------------------
			...
			preserve
				...
				export delimited "$pathData/intermediate/feedback/2023/daily_simulations/1_tables_public_format/crosswalk_id_mrun_`date'.csv", replace
			...
			export delimited "$pathData/intermediate/feedback/2023/daily_simulations/1_tables_public_format/B1_`date'.csv", replace

		// ----------------------------------------------------------------
		// C1
		// ----------------------------------------------------------------

			import delimited "$main_sae/datos_SAE/1_Source/1_Principal/postulaciones/datos_jpal_2023-`date'.csv", clear
			duplicates drop id_postulante rbd cod_curso, force 
			rename neep es_pie 
			...
			export delimited "$pathData/intermediate/feedback/2023/daily_simulations/1_tables_public_format/C1_`date'.csv", replace

		// ----------------------------------------------------------------
		// F1
		// ----------------------------------------------------------------

			import delimited "$main_sae/datos_SAE/1_Source/1_Principal/relaciones/F1_2023-`date'.csv", clear
			...
			export delimited "$pathData/intermediate/feedback/2023/daily_simulations/1_tables_public_format/F1_`date'.csv", replace
