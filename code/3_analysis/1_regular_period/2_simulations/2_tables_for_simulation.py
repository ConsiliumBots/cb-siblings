...
Path = "/Users/javieragazmuri/ConsiliumBots Dropbox/ConsiliumBots/Projects/Chile/Siblings/data/intermediate/feedback/2023/jpal_to_public_data/"
...
# Leemos archivos
A1 = pd.read_csv(Path + context + "A1.csv")
B1 = pd.read_csv(Path + context + "B1.csv")
C1 = pd.read_csv(Path + context + "C1.csv")
# D1 = pd.read_csv(Path + "D1.csv",sep=';')
F1 = pd.read_csv(Path + context + "F1.csv")
...
priority_profiles = pd.read_csv(Path + 'SAE_2022_priority_profiles.csv')
...
applicants.to_csv(Path + context + 'applicants.csv',index=False)
applications.to_csv(Path + context + 'applications.csv',index=False)
vacancies.to_csv(Path + context + 'vacancies.csv',index=False)
links.to_csv(Path + context + 'links.csv',index=False)
siblings.to_csv(Path + context + 'siblings.csv',index=False)
#results.to_csv(Outputs_Path + context + 'results.csv',index=False)